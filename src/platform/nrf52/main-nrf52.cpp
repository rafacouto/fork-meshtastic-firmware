...
#ifdef MESHTASTIC_NRF52_ENABLE_BROWNOUT_RESET
    // Configure hardware brownout reset (automatic reset when VCC < 2.7V)
    // This works independently of SoftDevice
    NRF_POWER->POFCON = (POWER_POFCON_POF_Enabled << POWER_POFCON_POF_Pos) |
                        (POWER_POFCON_THRESHOLD_V27 << POWER_POFCON_THRESHOLD_Pos);
    LOG_INFO("Hardware brownout reset enabled at 2.7V");
#endif
